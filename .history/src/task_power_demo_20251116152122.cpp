...
// ==================== SIMULATION MODE ====================
// Set to true for terminal-only testing
...
void enter_light_sleep(uint32_t time_ms) {
    if (SIMULATION_MODE) {
        ...
        // Simulate power consumption drop
    ...
    // Real implementation (when you have hardware)
...
void calculate_power_savings() {
    ...
    float battery_mah = 500.0;  // Example battery
